...
public class Commands
{
            ...
            final SkinLookup skinLookup)
    {
        ...
        if (editingDomain != null)
        {
            for (final GNode node : model.getNodes())
            {
                ...
                if (nodeSkin != null )
                {
                    checkNodeChanged(editingDomain, command, node, nodeSkin);
                }
            }
     ...
     *         {@code false if not}
     */
    private static boolean checkNodeChanged(final EditingDomain editingDomain, final CompoundCommand command,
                                            final GNode node, final GNodeSkin nodeSkin)
    {
