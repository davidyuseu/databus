...
import sy.grapheditor.api.utils.ResizableBox;
...
public abstract class GNodeSkin extends GSkin<GNode> {
    ...
    protected void initLayoutX() {
        getRoot().setLayoutX(getItem().getX());
    }

    protected void initLayoutY() {
    ...
    protected boolean appendCmdWhenWidthOrHeightChange() {
        return true;
    }
