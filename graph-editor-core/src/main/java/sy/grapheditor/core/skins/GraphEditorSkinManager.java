...
import sy.grapheditor.core.skins.defaults.DefaultConnectionSkin;
import sy.grapheditor.core.skins.defaults.DefaultConnectorSkin;
import sy.grapheditor.core.skins.defaults.DefaultJointSkin;
import sy.grapheditor.core.skins.defaults.DefaultNodeSkin;
...
public class GraphEditorSkinManager implements SkinManager
{
    ...
    public Map<GNode, GNodeSkin> getMNodeSkins() { return mNodeSkins;}
    ...
    public GNodeSkin lookupNode(long id) {
        for (GNode node : mNodeSkins.keySet()) {
            if (node.getId() == id)
                return mNodeSkins.get(node);
        }
        return null;
    }
