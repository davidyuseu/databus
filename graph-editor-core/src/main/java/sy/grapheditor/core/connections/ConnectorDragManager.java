...
import sy.grapheditor.core.skins.defaults.utils.ConnectionCommands;
...
public class ConnectorDragManager {
     ...
     *
     * @param skinLookup             the {@link SkinLookup} used to look up connector and tail
     *                               skins
     * @param connectionEventManager the {@link ConnectionEventManager} used to notify users of
     *                               connection events
     * @param view                   the {@link GraphEditorView} to which tail skins will be added
     ...
     *
     * @param validator a {@link GConnectorValidator} implementation, or null to use
     *                  the default
     */
     ...
     *
     * @param event     the {@link MouseEvent} that caused the connection to be
     *                  detached
