...
public class GraphPackageImpl extends EPackageImpl implements GraphPackage {
	...
	public static GraphPackage init() {
		...
		GraphPackageImpl theGraphPackage = (GraphPackageImpl)(Registry.INSTANCE.get(eNS_URI) instanceof GraphPackageImpl ? Registry.INSTANCE.get(eNS_URI) : new GraphPackageImpl());
	...
	@Override
	public EAttribute getGNode_Processor_ClassName() {
		return (EAttribute)gNodeEClass.getEStructuralFeatures().get(7);
	}

	@Override
	public EAttribute getGNode_Processor_Json() {
	...
	public void createPackageContents() {
		...
		createEAttribute(gNodeEClass, GNODE__PROCESSOR_CLASS_NAME);
		createEAttribute(gNodeEClass, GNODE__PROCESSOR_JSON);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getGNode_Id(), ecorePackage.getELong(), "id", "0", 0, 1, GNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGNode_Processor_ClassName(),ecorePackage.getEString(), "processorClassName", "null", 0, 1, GNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGNode_Processor_Json(),ecorePackage.getEString(), "processorJson", "20211203", 0, 1, GNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
