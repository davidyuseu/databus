...
public enum CellDataTypeEnum {
    ...
    private static final Map<String, excel.enums.CellDataTypeEnum> TYPE_ROUTING_MAP = new HashMap<String, excel.enums.CellDataTypeEnum>(16);
     ...
     * @return
     */
    public static excel.enums.CellDataTypeEnum buildFromCellType(String cellType) {
