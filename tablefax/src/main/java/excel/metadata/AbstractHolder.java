...
public abstract class AbstractHolder implements ConfigurationHolder {
    ...
    /**
     * You can only choose one of the {@link excel.metadata.AbstractHolder#head} and {@link excel.metadata.AbstractHolder#clazz}
     */
    ...
    public AbstractHolder(BasicParameter basicParameter, excel.metadata.AbstractHolder prentAbstractHolder) {
