 ...
 * a top-left and bottom-right cell, depending on the {@link excel.metadata.data.ClientAnchorData.AnchorType}:
 * <ol>
...
public class ClientAnchorData extends CoordinateData {
    ...
    public enum AnchorType {
         ...
         */
        @Internal
        public static excel.metadata.data.ClientAnchorData.AnchorType byId(int value) {
            return values()[value];
        }
    }
}
