...
import excel.annotation.write.style.OnceAbsoluteMerge;
...
public class OnceAbsoluteMergeProperty {
    ...
    public static excel.metadata.property.OnceAbsoluteMergeProperty build(OnceAbsoluteMerge onceAbsoluteMerge) {
        if (onceAbsoluteMerge == null) {
            return null;
        }
        return new excel.metadata.property.OnceAbsoluteMergeProperty(onceAbsoluteMerge.firstRowIndex(), onceAbsoluteMerge.lastRowIndex(),
