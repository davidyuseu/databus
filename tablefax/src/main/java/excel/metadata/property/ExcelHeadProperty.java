...
import excel.util.ClassUtils;
import excel.util.FieldUtils;
...
public class ExcelHeadProperty {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(excel.metadata.property.ExcelHeadProperty.class);
    /**
     * Custom class
     */
