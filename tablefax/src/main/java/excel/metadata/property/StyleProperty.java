...
import excel.annotation.write.style.ContentStyle;
import excel.annotation.write.style.HeadStyle;
import excel.metadata.data.DataFormatData;
import excel.write.metadata.style.WriteFont;
...
public class StyleProperty {
    ...
    public static excel.metadata.property.StyleProperty build(HeadStyle headStyle) {
        if (headStyle == null) {
            return null;
        }
        excel.metadata.property.StyleProperty styleProperty = new excel.metadata.property.StyleProperty();
    ...
    public static excel.metadata.property.StyleProperty build(ContentStyle contentStyle) {
