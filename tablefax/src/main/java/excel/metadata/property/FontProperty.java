...
import excel.annotation.write.style.ContentFontStyle;
import excel.annotation.write.style.HeadFontStyle;
...
public class FontProperty {
    ...
    public static excel.metadata.property.FontProperty build(HeadFontStyle headFontStyle) {
        if (headFontStyle == null) {
            return null;
        }
        excel.metadata.property.FontProperty styleProperty = new excel.metadata.property.FontProperty();
    ...
    public static excel.metadata.property.FontProperty build(ContentFontStyle contentFontStyle) {
