...
import excel.read.metadata.holder.ReadHolder;
...
import excel.read.processor.AnalysisEventProcessor;
...
public interface AnalysisContext {
     ...
     * Interrupt execution
     *
     * @deprecated please use {@link AnalysisEventListener#hasNext(excel.context.AnalysisContext)}
     */
    @Deprecated
    void interrupt();
}
