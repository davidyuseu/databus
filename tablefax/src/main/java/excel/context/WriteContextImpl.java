package excel.context;

import excel.enums.WriteTypeEnum;
...
public class WriteContextImpl implements WriteContext {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(excel.context.WriteContextImpl.class);
    ...
    private void addMergedRegionToCurrentSheet(ExcelWriteHeadProperty excelWriteHeadProperty, int rowIndex) {
        for (excel.metadata.CellRange cellRangeModel : excelWriteHeadProperty.headCellRangeList()) {
