package excel.write.metadata.style;

import excel.constant.BuiltinFormats;
import excel.metadata.data.DataFormatData;
import excel.metadata.property.FontProperty;
import excel.metadata.property.StyleProperty;
...
public class WriteCellStyle {
     ...
     * @param target target
     */
    public static void merge(excel.write.metadata.style.WriteCellStyle source, excel.write.metadata.style.WriteCellStyle target) {
     ...
     */
    public static excel.write.metadata.style.WriteCellStyle build(StyleProperty styleProperty, FontProperty fontProperty) {
        if (styleProperty == null && fontProperty == null) {
            return null;
        }
        excel.write.metadata.style.WriteCellStyle writeCellStyle = new excel.write.metadata.style.WriteCellStyle();
        buildStyleProperty(styleProperty, writeCellStyle);
        buildFontProperty(fontProperty, writeCellStyle);
        return writeCellStyle;
    }

    private static void buildFontProperty(FontProperty fontProperty, excel.write.metadata.style.WriteCellStyle writeCellStyle) {
    ...
    private static void buildStyleProperty(StyleProperty styleProperty, excel.write.metadata.style.WriteCellStyle writeCellStyle) {
