package excel.write.metadata.holder;
...
import excel.enums.HeadKindEnum;
import excel.event.NotRepeatExecutor;
import excel.metadata.AbstractHolder;
import excel.metadata.Head;
import excel.metadata.property.ExcelContentProperty;
import excel.metadata.property.LoopMergeProperty;
import excel.metadata.property.OnceAbsoluteMergeProperty;
import excel.metadata.property.RowHeightProperty;
import excel.write.handler.*;
import excel.write.handler.chain.CellHandlerExecutionChain;
import excel.write.handler.chain.RowHandlerExecutionChain;
import excel.write.handler.chain.SheetHandlerExecutionChain;
import excel.write.handler.chain.WorkbookHandlerExecutionChain;
import excel.write.handler.context.CellWriteHandlerContext;
import excel.write.merge.LoopMergeStrategy;
import excel.write.merge.OnceAbsoluteMergeStrategy;
import excel.write.metadata.WriteBasicParameter;
import excel.write.metadata.style.WriteCellStyle;
import excel.write.property.ExcelWriteHeadProperty;
import excel.write.style.AbstractVerticalCellStyleStrategy;
import excel.write.style.column.AbstractHeadColumnWidthStyleStrategy;
import excel.write.style.row.SimpleRowHeightStyleStrategy;
...
public abstract class AbstractWriteHolder extends AbstractHolder implements WriteHolder {
    ...
    public AbstractWriteHolder(WriteBasicParameter writeBasicParameter, excel.write.metadata.holder.AbstractWriteHolder parentAbstractWriteHolder) {
    ...
    protected void initHandler(WriteBasicParameter writeBasicParameter, excel.write.metadata.holder.AbstractWriteHolder parentAbstractWriteHolder) {
        // Set writeHandlerMap
