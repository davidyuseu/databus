...
public class RowHandlerExecutionChain {
     ...
     * next chain
     */
    private excel.write.handler.chain.RowHandlerExecutionChain next;
    /**
     * handler
     */
    ...
    public void addLast(RowWriteHandler handler) {
        excel.write.handler.chain.RowHandlerExecutionChain context = this;
        while (context.next != null) {
            context = context.next;
        }
        context.next = new excel.write.handler.chain.RowHandlerExecutionChain(handler);
    }
}
