...
import excel.write.handler.WorkbookWriteHandler;
...
public class WorkbookHandlerExecutionChain {
     ...
     * next chain
     */
    private excel.write.handler.chain.WorkbookHandlerExecutionChain next;
    ...
    public void addLast(WorkbookWriteHandler handler) {
        excel.write.handler.chain.WorkbookHandlerExecutionChain context = this;
        while (context.next != null) {
            context = context.next;
        }
        context.next = new excel.write.handler.chain.WorkbookHandlerExecutionChain(handler);
    }
}
