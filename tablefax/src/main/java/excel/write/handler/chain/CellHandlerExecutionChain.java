...
public class CellHandlerExecutionChain {
     ...
     * next chain
     */
    private excel.write.handler.chain.CellHandlerExecutionChain next;
    /**
     * handler
     */
    ...
    public void addLast(CellWriteHandler handler) {
        excel.write.handler.chain.CellHandlerExecutionChain context = this;
        while (context.next != null) {
            context = context.next;
        }
        context.next = new excel.write.handler.chain.CellHandlerExecutionChain(handler);
    }
}
