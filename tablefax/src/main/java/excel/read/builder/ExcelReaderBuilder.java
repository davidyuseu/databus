 ...
 * @author Jiaju Zhuang
 */
public class ExcelReaderBuilder extends AbstractExcelReaderParameterBuilder<excel.read.builder.ExcelReaderBuilder, ReadWorkbook> {
    /**
     * Workbook
     */
    ...
    public excel.read.builder.ExcelReaderBuilder excelType(ExcelTypeEnum excelType) {
     ...
     */
    public excel.read.builder.ExcelReaderBuilder file(InputStream inputStream) {
     ...
     * If 'inputStream' and 'file' all not empty, file first
     */
    public excel.read.builder.ExcelReaderBuilder file(File file) {
     ...
     * If 'inputStream' and 'file' all not empty, file first
     */
    public excel.read.builder.ExcelReaderBuilder file(String pathName) {
     ...
     */
    public excel.read.builder.ExcelReaderBuilder mandatoryUseInputStream(Boolean mandatoryUseInputStream) {
     ...
     * @return
     */
    public excel.read.builder.ExcelReaderBuilder autoCloseStream(Boolean autoCloseStream) {
     ...
     * @return
     */
    public excel.read.builder.ExcelReaderBuilder ignoreEmptyRow(Boolean ignoreEmptyRow) {
     ...
     * @return
     */
    public excel.read.builder.ExcelReaderBuilder customObject(Object customObject) {
     ...
     * @return
     */
    public excel.read.builder.ExcelReaderBuilder readCache(ReadCache readCache) {
     ...
     * @return
     */
    public excel.read.builder.ExcelReaderBuilder readCacheSelector(ReadCacheSelector readCacheSelector) {
     ...
     * @return
     */
    public excel.read.builder.ExcelReaderBuilder password(String password) {
     ...
     * @return
     */
    public excel.read.builder.ExcelReaderBuilder xlsxSAXParserFactoryName(String xlsxSAXParserFactoryName) {
     ...
     * @return
     */
    public excel.read.builder.ExcelReaderBuilder extraRead(CellExtraTypeEnum extraType) {
     ...
     * @return
     */
    public excel.read.builder.ExcelReaderBuilder useDefaultListener(Boolean useDefaultListener) {
