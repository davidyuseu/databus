...
import excel.write.ExcelBuilder;
import excel.write.ExcelBuilderImpl;
...
public class ExcelWriter {
     ...
     */
    public excel.ExcelWriter write(Collection<?> data, WriteSheet writeSheet) {
     ...
     * @return this current writer
     */
    public excel.ExcelWriter write(Supplier<Collection<?>> supplier, WriteSheet writeSheet) {
     ...
     * @return this
     */
    public excel.ExcelWriter write(Collection<?> data, WriteSheet writeSheet, WriteTable writeTable) {
     ...
     * @return this
     */
    public excel.ExcelWriter write(Supplier<Collection<?>> supplier, WriteSheet writeSheet, WriteTable writeTable) {
     ...
     * @return
     */
    public excel.ExcelWriter fill(Object data, WriteSheet writeSheet) {
     ...
     * @return
     */
    public excel.ExcelWriter fill(Object data, FillConfig fillConfig, WriteSheet writeSheet) {
     ...
     * @return
     */
    public excel.ExcelWriter fill(Supplier<Object> supplier, WriteSheet writeSheet) {
     ...
     * @return
     */
    public excel.ExcelWriter fill(Supplier<Object> supplier, FillConfig fillConfig, WriteSheet writeSheet) {
